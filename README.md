...
![Platform](https://img.shields.io/badge/Platform-MATLAB-lightgrey)
...
2. Load the robot parameters
3. Run a multi‑step walking simulation
4. Display an animation of the RABBIT robot
